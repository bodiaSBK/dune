...
<div class="main_news">
	   ...
	   [xfgiven_image] 
		...
		[/xfgiven_image]
        <div class="mn_picts">
            [xfgiven_screen]<img src="[xfvalue_screen]" alt="{title}" title="{title}">[/xfgiven_screen]
            [xfgiven_screen2]<img src="[xfvalue_screen2]" alt="{title}" title="{title}">[/xfgiven_screen2]
         </div>
   </div>
