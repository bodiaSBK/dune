...
HTML;
	...
	showRow( "Путь к контенту передаваемому телевизорам", "Должен начинаться на <b>http://</b> и содержать в конце знак <b>/</b>.<br />Доступные теги: {tv-addr} - IP-адрес телевизора", "<input class=\"edit bk\" type=text style=\"text-align: center;\" name=\"save_con[moviex_path]\" value=\"{$config['moviex_path']}\" size=50>" );
